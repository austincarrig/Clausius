...
#pragma makr - Lazy Init Containers
...
-(UILabel *)temperatureLabel
{
	if (!_temperatureLabel) {
		_temperatureLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
{
	if (!_pressureLabel) {
		_pressureLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
-(UILabel *)specificVolumeLabel
{
	if (!_specificVolumeLabel) {
		_specificVolumeLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
-(UILabel *)internalEnergyLabel
{
	if (!_internalEnergyLabel) {
		_internalEnergyLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
{
	if (!_enthalpyLabel) {
		_enthalpyLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
{
	if (!_entropyLabel) {
		_entropyLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
{
	if (!_qualityLabel) {
		_qualityLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
-(UITextField *)temperatureTextField
{
	if (!_temperatureTextField) {
		_temperatureTextField = [[UITextField alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
-(UITextField *)pressureTextField
{
	if (!_pressureTextField) {
		_pressureTextField = [[UITextField alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
-(UITextField *)specificVolumeTextField
{
	if (!_specificVolumeTextField) {
		_specificVolumeTextField = [[UITextField alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
-(UITextField *)internalEnergyTextField
{
	if (!_internalEnergyTextField) {
		_internalEnergyTextField = [[UITextField alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
-(UITextField *)enthalpyTextField
{
	if (!_enthalpyTextField) {
		_enthalpyTextField = [[UITextField alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
-(UITextField *)entropyTextField
{
	if (!_entropyTextField) {
		_entropyTextField = [[UITextField alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
-(UITextField *)qualityTextField
{
	if (!_qualityTextField) {
		_qualityTextField = [[UITextField alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
-(UILabel *)temperatureUnitsLabel
{
	if (!_temperatureUnitsLabel) {
		_temperatureUnitsLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
-(UILabel *)pressureUnitsLabel
{
	if (!_pressureUnitsLabel) {
		_pressureUnitsLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
-(UILabel *)specificVolumeUnitsLabel
{
	if (!_specificVolumeUnitsLabel) {
		_specificVolumeUnitsLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
-(UILabel *)internalEnergyUnitsLabel
{
	if (!_internalEnergyUnitsLabel) {
		_internalEnergyUnitsLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
-(UILabel *)enthalpyUnitsLabel
{
	if (!_enthalpyUnitsLabel) {
		_enthalpyUnitsLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
-(UILabel *)entropyUnitsLabel
{
	if (!_entropyUnitsLabel) {
		_entropyUnitsLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
...
-(UILabel *)qualityUnitsLabel
{
	if (!_qualityUnitsLabel) {
		_qualityUnitsLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/4.0, self.frame.size.height/6.0)];
